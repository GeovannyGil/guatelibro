...
function Header(){
        ...
        $this->Image('http://localhost/sistema_zapateria/assets/img/logor.png',255,2,20);
        $this->setY(25);
...
function FancyTable($header, $data,$w)
{
    ...
    foreach($data as $row)
    {
        ...
        $this->Cell($w[4],17,$this->Image('http://localhost/sistema_zapateria/assets/img/'.$row[4].'',$this->GetX()+10, $this->GetY()+2, 18),1,0,'C',false);
        $this->Ln();
        $fill = !$fill;
    }
    // Línea de cierre
