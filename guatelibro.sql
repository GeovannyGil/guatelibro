...
alter table suscriptions ADD foreign key (id_payments) references payments(id_payments);
alter table payments ADD foreign key (id_member) references members(id_member);
alter table payments ADD foreign key (id_membership) references membership(id_membership);
