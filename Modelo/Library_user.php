...
Class Library_user{
    public function buscarLibrary_user(){
        $modelo= new Conexion();
    ...
    public function InsertarLibrary_user($id_member, $id_product){
        $modelo= new Conexion();
        $conexion=$modelo->obtener_conexion();
    ...
    public function EliminarLibrary_user($id_user){
        $modelo= new Conexion();
        $conexion=$modelo->obtener_conexion();
    ...
    public function ActualizarLibrary_user($id_member, $id_product,$id){
        $modelo= new Conexion();
        $conexion=$modelo->obtener_conexion();
